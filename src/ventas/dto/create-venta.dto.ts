...
export class CreateVentaDto {
  @IsOptional()
  @IsDateString({}, { message: 'La fecha debe tener un formato válido (YYYY-MM-DDTHH:mm:ss.sssZ)' })
  @Transform(({ value }) => value ? new Date(value) : undefined)
  fecha?: Date;

  @IsNotEmpty({ message: 'El tipo de venta es requerido' })
  @IsEnum(TipoVentaEnum, { message: 'El tipo de venta debe ser Presencial u Online' })
  tipo_venta: TipoVentaEnum;

  @IsNotEmpty({ message: 'El tipo de pago es requerido' })
  @IsEnum(TipoPagoEnum, { message: 'El tipo de pago debe ser Efectivo, Tarjeta o Transferencia' })
  ...
  @IsOptional()
  @IsDecimal({ decimal_digits: '0,2' }, { message: 'El subtotal debe tener máximo 2 decimales' })
  ...
  @IsOptional()
  @IsDecimal({ decimal_digits: '0,2' }, { message: 'El descuento debe tener máximo 2 decimales' })
